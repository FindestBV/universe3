              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 group-hover:text-white">
                      Start a new research study, a workspace to gather and present acquired
                ...
                {formData.type === "query" && (
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={handleQueryTemplateSelect}
                    >
                      <SelectTrigger className="w-full border border-gray-200 bg-white">
              ...
              <div className="space-y-6">
                <div className="space-y-4 rounded-lg border border-gray-200 p-6">
                  <div>
                    ...
                    <p className="text-lg font-semibold capitalize text-[#006A86]">
                      {formData.type}
                    </p>
                  </div>
                  {formData.pageType && (
